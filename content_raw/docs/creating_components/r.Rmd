...
NOTICE: This documentation might be outdated. Please be patient while the tutorial is being rewritten.
...
A [viash config](/docs/reference_config/config) file describes the behaviour of a script and the platform it runs on.
...
and [Nextflow](/docs/reference_config/platform-native). If no platforms are specified, a native platform with no 
