...
* Make sure you have a [GitHub account](https://github.com/signup/free). If you are not familar with git and GitHub, take a look at [http://happygitwithr.com/](http://happygitwithr.com/) to get started.
...
* viash is written primarily in [Scala](https://www.scala-lang.org/). We recommend using [IntelliJ Idea](https://www.jetbrains.com/idea/) as your IDE, but you're free to use alternatives.
